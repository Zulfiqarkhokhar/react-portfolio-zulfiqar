...
const projects=["Tracking App","Ecommerce","Notebook App","Calender","ChiChat App","Digital Gaurdian App","Tracking App","Ecommerce","Notebook App","Calender","ChiChat App","Digital Gaurdian App"];
const AllProject = () => {
    return (
        <>
